...
export function suggestEpsilon(embeddings, k = 4) {
  ...
  // Find the "elbow" point - use 50th percentile for tighter clusters
  // This produces more distinct groups rather than lumping everything together
  const elbowIndex = Math.floor(distances.length * 0.5);
